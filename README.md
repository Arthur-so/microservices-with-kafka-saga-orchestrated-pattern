...
Repositório contendo o projeto desenvolvido do curso Arquitetura de Microsserviços: Padrão Saga Orquestrado, ministrado por [Victor Hugo Negrisoli](https://github.com/vhnegrisoli) para a plataforma **Udemy**.
